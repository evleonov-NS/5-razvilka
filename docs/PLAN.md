...
| LLM / ядро продукта | ✅ Этапы 4–5; далее дерево (7) / ревью (8) |

| Production Neon | ⚠️ `migrate deploy` вручную или в Build Command |



**Следующий шаг:** **Этап 7** — дерево развилок; затем ревью (8) / полировка (9).
...
1. **Этап 7** — дерево развилок

2. **Этап 8** — ревью по исходу (RESOLVED)

3. **Этап 9** — полировка + ключи LLM в Vercel; **2а** — кнопки демо в settings
