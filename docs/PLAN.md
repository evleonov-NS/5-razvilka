...
| LLM / ядро продукта | ✅ Этапы 4–5, 7; далее ревью (8) |

| Production Neon | ⚠️ `migrate deploy` вручную или в Build Command |



**Следующий шаг:** **Этап 8** — ревью по исходу; затем полировка (9).
...
1. **Этап 8** — ревью по исходу (RESOLVED)

2. **Этап 9** — полировка + ключи LLM в Vercel

3. **Этап 2а** — кнопки демо в settings
